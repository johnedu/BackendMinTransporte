(function () {
    angular.module('app').controller('modalNuevaCategoriaController', ['$scope', '$modalInstance', '$http', '$timeout', 'Upload', 'abp.services.app.utilidades', 'abp.services.app.administracion',
