(function () {
    angular.module('app').controller('modalNuevoNoticiaController', ['$scope', '$modalInstance', '$http', '$timeout', 'Upload', 'abp.services.app.utilidades', 'abp.services.app.administracion',
