(function () {
    angular.module('app').controller('modalNuevoDiagnosticoController', ['$scope', '$modalInstance', '$http', '$timeout', 'Upload', 'abp.services.app.utilidades', 'abp.services.app.administracion',
