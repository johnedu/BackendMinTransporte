(function () {
    angular.module('app').controller('modalEditarDiagnosticoController', ['$scope', '$modalInstance', 'diagnosticoEditar', '$http', '$timeout', 'Upload', 'abp.services.app.utilidades', 'abp.services.app.administracion',
        function ($scope, $modalInstance, diagnosticoEditar, $http, $timeout, Upload, utilidadesService, administracionService) {
                    ...
                    (function (index) {
                        $scope.upload[index] = Upload.upload({
                            ...
                            utilidadesService.readFile({ ruta: data.returnData, realFileName: data.returnDataType })
                                .success(function (data) {
                                    $scope.diagnostico.urlImagen = data.urlImagen;
